package com.taja.interfaces.api.weather;
...
public class WeatherController {
    ...
    @Operation(summary = "자치구 지점 좌표 업로드", description = "자치구 지점 좌표 정보를 수집하여 저장합니다.")
    ...
    @Operation(summary = "초단기실황 날씨 업로드", description = "자치구별 초단기실황 날씨 정보를 수집하여 저장합니다.")
    @PostMapping("/upload")
