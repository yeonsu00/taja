package com.taja.statistics.presentation;

import com.taja.global.response.CommonApiResponse;
import com.taja.statistics.application.StatisticsService;
import com.taja.statistics.presentation.request.StatisticsRequest;
...
public class StatisticsController {
    ...
    public CommonApiResponse<String> calculateHourlyStatistics(@Valid @RequestBody StatisticsRequest request) {
        int count = statisticsService.calculateHourlyStatistics(request.requestedAt());
    ...
    public CommonApiResponse<String> calculateDayOfWeekStatistics(@Valid @RequestBody StatisticsRequest request) {
        int count = statisticsService.calculateDayOfWeekStatistics(request.requestedAt());
    ...
    public CommonApiResponse<String> calculateTemperatureStatistics(@Valid @RequestBody StatisticsRequest request) {
        int count = statisticsService.calculateTemperatureStatistics(request.requestedAt());
