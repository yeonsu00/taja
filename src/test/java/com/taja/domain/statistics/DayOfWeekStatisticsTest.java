...
class DayOfWeekStatisticsTest {
    ...
    class UpdateAvgParkingBikeCount {
        ...
        void calculatesAverageCorrectly_whenOneSampleExists() {
            ...
            DayOfWeekStatistics statistics = DayOfWeekStatistics.create(stationId, dayOfWeek, firstValue);
        ...
        void calculatesAverageCorrectly_whenMultipleSamplesExist() {
            ...
            DayOfWeekStatistics statistics = DayOfWeekStatistics.create(stationId, dayOfWeek, 10);
        ...
        void calculatesAverageCorrectly_whenSameValuesAreAdded() {
            ...
            Integer value = 10;
            DayOfWeekStatistics statistics = DayOfWeekStatistics.create(stationId, dayOfWeek, value);
        ...
        void calculatesAverageCorrectly_whenLargeValuesAreAdded() {
            ...
            DayOfWeekStatistics statistics = DayOfWeekStatistics.create(stationId, dayOfWeek, 100);
